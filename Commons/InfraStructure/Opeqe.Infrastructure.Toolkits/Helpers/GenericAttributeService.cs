...
namespace Opeqe.Infrastructure.Toolkits.Helpers
{
    ...
    public partial interface IGenericAttributeService
    {
        ...
        void SaveAttribute<TPropType>(Entity entity, string key, TPropType value, int storeId = 0);
        ...
        TPropType GetAttribute<TPropType>(Entity entity, string key, int storeId = 0, TPropType defaultValue = default(TPropType));
    }
